...
This project implements a Matter Controller Server over WebSockets using the [official Matter SDK](https://github.com/project-chip/connectedhomeip) as a base and provides both a server and client implementation.
